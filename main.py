...
def endScreen(window):
    ...
    text_surface = my_font.render('Player 1 Wins!', False, (0, 0, 0))
...
def endScreenCompWin(window):
    ...
    my_font = pygame.font.SysFont('Comic Sans MS', 30)
    text_surface = my_font.render('Computer Wins', False, (0, 0, 0))
    window.blit(text_surface, (0, 0))
...
STAGE = ['Main Menu', 'Deployment', 'Game Over', 'CompWin']
                    ...
                    if button.rect.collidepoint(pygame.mouse.get_pos()):
                        if button.name == 'Deploy' and button.active == True:
                            ...
                            BLIPPOSITION = pick_random_ship_location(cGameLogic)
                                ...
                                button.name == 'Easy Computer' or button.name == 'Hard Computer') and button.active == True:
